...
void ofApp::draw() {
    ...
    ofDrawBitmapString("to mix between camera and framebuffer press s and x"+ofToString(ss)+" to change delay amount press d and c "+ofToString(abs(dd)%fbob)+"framerate "+ofToString(ofGetFrameRate())
                      ,
                       10, ofGetHeight()-5 );
